...
var sckey = _interopDefault(require('soundcloud-key-fetch'));
var m3u8stream = _interopDefault(require('m3u8stream'));
var url = require('url');
...
var appendURL = function appendURL(url$1) {
  for (var _len = arguments.length, params = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    params[_key - 1] = arguments[_key];
  }

  var u = new url.URL(url$1);
...
//# sourceMappingURL=soundcloud-downloader.cjs.development.js.map
